    ...
    <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg max-w-none space-y-8">
        ...
        <section>
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Account Information</h3>
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Service-Specific Data</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">AI-Generated Content</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Social Media Platforms</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">AI Service Providers</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Text-to-Speech Providers</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Cloud Infrastructure</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Right to Access</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
            You can request a copy of the personal information we hold about you. We will provide this information
            in a structured, commonly used, and machine-readable format.
          </p>

          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Right to Correction</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
            You can update or correct inaccurate personal information through your account settings or by contacting
            us directly.
          </p>

          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Right to Deletion</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Additional Rights</h3>
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Preference Cookies</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
