# SnowForge Infrastructure Documentation
...
**SnowForge** - SnowForge LLC landing page - showcases the SnowForge product suite
...
**Status**: Not applicable - This project does not require a database.
...
```bash
NODE_ENV=production
NEXT_PUBLIC_APP_URL=https://snowforge.dev
```
...
| 2026-03-25 | Updated production URL, hosting, and deployment details | Engineering Team |
